...
H2BLBMandatoryPostLegalizerCombinerImpl::H2BLBMandatoryPostLegalizerCombinerImpl(
    MachineFunction &MF, CombinerInfo &CInfo, const TargetPassConfig *TPC,
    GISelCSEInfo *CSEInfo,
    const H2BLBMandatoryPostLegalizerCombinerImplRuleConfig &RuleConfig,
    const H2BLBSubtarget &STI)
...
void H2BLBMandatoryPostLegalizerCombiner::getAnalysisUsage(AnalysisUsage &AU) const {
...
bool H2BLBMandatoryPostLegalizerCombiner::runOnMachineFunction(MachineFunction &MF) {
  ...
  H2BLBMandatoryPostLegalizerCombinerImpl Impl(MF, CInfo, TPC, /*CSEInfo*/ nullptr,
                                        RuleConfig, ST);
